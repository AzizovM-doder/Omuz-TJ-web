...
en.hub.crm.desc = "Management platform for academies and student tracking.";

// RU updates
ru.products_crm.subtitle = "Идеальный журнал студентов и система управления академией";
ru.products_crm.description = "Оптимизируйте работу вашего учебного заведения с помощью нашей специализированной платформы. От зачисления студентов до отслеживания посещаемости и успеваемости — Omuz CRM справится со всем.";
...
ru.hub.crm.desc = "Платформа управления для академий и отслеживания студентов.";

// TJ updates
tj.products_crm.subtitle = "Беҳтарин журнали донишҷӯён ва системаи идоракунии академия";
tj.products_crm.description = "Кори муассисаи таълимии худро бо платформаи махсуси мо осон кунед. Аз қабули донишҷӯён то назорати давомот ва пешрафт — хуллас Omuz CRM ҳамаи инро идора мекунад.";
...
tj.hub.crm.desc = "Платформаи идоракунӣ барои академияҳо ва назорати донишҷӯён.";
