...
const translations_ru = {
    ...
    "products_crm.description": "Оптимизируйте работу вашего учебного центра с нашей универсальной платформой. От регистрации студентов до финансовой отчетности - Omuz CRM справляется со всем.",
    ...
    "products_crm.faq.q1": "Является ли Omuz CRM облачной платформой?",
    "products_crm.faq.a1": "Да, Omuz CRM полностью облачная платформа, обеспечивающая безопасный доступ из любого места.",
    ...
    "products_online.subtitle": "Платформа для обучения и корпоративного тренинга",
    ...
    "hero.slides.2.title": "Платформа Online Omuz",
    "hero.slides.2.subtitle": "Лучшая платформа для доступного и качественного цифрового образования.",
    ...
    "hub.online.desc": "Цифровая платформа для образования и тренингов.",
...
const translations_tj = {
    ...
    "products_crm.description": "Кори маркази таълимии худро бо платформаи мо осон кунед. Аз бақайдгирии донишҷӯён то ҳисоботи молиявӣ - Omuz CRM ҳамаи инро идора мекунад.",
    ...
    "products_crm.faq.q1": "Оё Omuz CRM платформаи абрӣ аст?",
    "products_crm.faq.a1": "Бале, Omuz CRM пурра платформаи абрӣ буда, дастрасии бехатарро аз ҳама ҷо таъмин мекунад.",
    ...
    "products_online.title": "Online Omuz",
    "products_online.subtitle": "Платформа барои омӯзиш ва тренингҳои корпоративӣ",
    ...
    "hero.slides.2.title": "Платформаи тарбиявии Online Omuz",
    "hero.slides.2.subtitle": "Платформаи беҳтарин барои таҳсилоти рақамии дастрас ва босифат.",
    ...
    "hub.online.title": "Online Omuz",
    "hub.online.desc": "Платформаи рақамӣ барои омӯзиш ва тренингҳо.",
